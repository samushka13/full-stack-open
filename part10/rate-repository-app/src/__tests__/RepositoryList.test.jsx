...
const getRepoName = (i) => TEST_DATA.edges[i].node.fullName;
...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(repositoryItems.length).toBe(TEST_DATA.edges.length);

      repositoryItems.forEach((item, i) =>
        expect(item).toHaveTextContent(getRepoName(i), { exact: false })
      );
    });
  });
});
